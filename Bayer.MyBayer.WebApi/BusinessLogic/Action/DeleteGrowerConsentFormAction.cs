...
{
    public class DeleteGrowerConsentFormAction : BusinessActionBase
    {
        private readonly ConsentData _consentData;

        public DeleteGrowerConsentFormAction(ConsentData consentData)
        {
        ...
        public override async Task<BusinessLogicEntity> Action(BusinessLogicEntity dto)
        {
            ...
            await _consentData.DeleteConsent(entity);
            return dto;
        }
    }
}